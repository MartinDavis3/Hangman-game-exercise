...
// newGameButton.addEventListener( 'onclick', function ( event ) {
...
guessForm.addEventListener( 'submit', function ( event ) {
    ...
    // Get the input
    var guessField: HTMLElement = document.getElementById( 'guess-input' );
    var guessValue = (<HTMLInputElement>guessField).value;
